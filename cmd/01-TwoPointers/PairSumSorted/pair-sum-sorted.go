...
func main() {
	...
	var inputs []Input = []Input{
		...
		{IntAscendingSortedArray: []int{1}, Target: 1},
		{IntAscendingSortedArray: []int{2, 3}, Target: 5},
		{IntAscendingSortedArray: []int{2, 4}, Target: 5},
		{IntAscendingSortedArray: []int{2, 3, 4}, Target: 5},
		{IntAscendingSortedArray: []int{-1, 2, 3}, Target: 2},
		{IntAscendingSortedArray: []int{-3, -2, -1}, Target: -5},
	}
